  ...
  try {
    ...
    ` : `
      SELECT 
        ...
        -- Calculate overall score for volleyball
        ROUND(
          (SUM(ps.kills) + SUM(ps.volleyball_blocks) + SUM(ps.service_aces) + 
    ...
    if (sportType === 'basketball') {
      ...
      // Volleyball - MVP from ALL players, not just champion team
